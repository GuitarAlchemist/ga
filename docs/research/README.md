...
|---|---|---|---|
| 2026-07-20 | [What is the SAE residual? (+ a third of OPTIC-K is dead)](2026-07-20-sae-residual-modal-morphology.md) | concluded | Residual is mostly NOT a vocabulary gap (64% is STRUCTURE-dominant); MODAL/MORPH enrichment only 1.3–1.6×. **Headline finding: 40/124 compact dims are always zero; CONTEXT is 11/12 dead.** Don't optimize purity |
