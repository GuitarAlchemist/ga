...
|---|---|---|---|
| 2026-07-20 | [SAE residual is modal + morphological](2026-07-20-sae-residual-modal-morphology.md) | concluded | The 441 "uninterpretable" features are real coherent structure (0.872 vs 0.721 random) concentrated in MODAL/MORPHOLOGY — partitions we built no vocabulary for. Don't optimize purity |
