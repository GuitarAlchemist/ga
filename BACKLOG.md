...
- **Research prerequisite (2026-07-02)**: the compounding deep-research produced **zero** verified findings on JEPA/Dreamer transfer to J4 (the angle came back empty — see the report, open question #2). A dedicated deep-research launched 2026-07-02 (2025-2026 state of the art, demonstrated transfers to code agents, explicit-trained vs frontier+calibration-ledger path for a team without lab compute, data prerequisites); report lands under `docs/research/`. **Do not start J4 before that report.** Not to be confused with [docs/research/world-models-diffusion-ga-eval.md](docs/research/world-models-diffusion-ga-eval.md) (world models for **music-product surfaces**, verdict DEFER — different scope: J4 targets process telemetry, not musical surfaces).
