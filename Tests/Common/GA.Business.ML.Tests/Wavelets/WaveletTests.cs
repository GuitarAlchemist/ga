...
public class WaveletTests
{
    ...
    public void Test_Haar_ConstantSignal()
    {
        ...
        var decomp = _service.Decompose(signal, WaveletTransformService.WaveletFamily.Haar, 1);
    ...
    public void Test_Daubechies4_StepSignal()
    {
        ...
        var decomp = _service.Decompose(signal, WaveletTransformService.WaveletFamily.Daubechies4, 1);
