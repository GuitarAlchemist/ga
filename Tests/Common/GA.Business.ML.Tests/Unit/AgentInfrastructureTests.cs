...
public class AgentInfrastructureTests
{
    ...
    public async Task TheoryAgent_FormulatesCorrectPrompt()
    {
        ...
        _chatClientMock.Setup(c => c.GetResponseAsync(It.IsAny<IEnumerable<ChatMessage>>(), It.IsAny<ChatOptions>(), default))
        ...
        _chatClientMock.Verify(c => c.GetResponseAsync(
            It.Is<IEnumerable<ChatMessage>>(m => m.Any(msg => msg.Text != null && msg.Text.Contains("atonal and tonal theory"))),
    ...
    public async Task TabAgent_FormulatesCorrectPrompt()
    {
        ...
        _chatClientMock.Verify(c => c.GetResponseAsync(
            It.Is<IEnumerable<ChatMessage>>(m => m.Any(msg => msg.Text != null && msg.Text.Contains("guitar tablature"))),
            It.IsAny<ChatOptions>(),
            default), Times.Once);
    }
