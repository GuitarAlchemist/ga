...
public class OpticKEquivalencyTests
{
    ...
    public void Transposition_Invariance_ICV_Match()
    {
        ...
        var vC = TheoryVectorService.ComputeEmbedding(cMajorPcs, intervalClassVector: icv);
        var vG = TheoryVectorService.ComputeEmbedding(gMajorPcs, intervalClassVector: icv);
    ...
    public void Involution_Invariance_ICV_Match()
    {
        ...
        const string icv = "001110";
        var vMaj = TheoryVectorService.ComputeEmbedding(cMajorPcs, intervalClassVector: icv);
        var vMin = TheoryVectorService.ComputeEmbedding(cMinorPcs, intervalClassVector: icv);
        // ICV indices are 13-18
        for (var i = 13; i <= 18; i++)
        {
    ...
    public void Cardinality_Encoding_Correct()
    {
        ...
        var v3 = TheoryVectorService.ComputeEmbedding(pcs3);
        var v4 = TheoryVectorService.ComputeEmbedding(pcs4);
    ...
    public void Identity_Encoding_OneHot_Correct()
    {
        ...
        var vChord = IdentityVectorService.ComputeEmbedding(IdentityVectorService.ObjectKind.Chord);
        var vScale = IdentityVectorService.ComputeEmbedding(IdentityVectorService.ObjectKind.Scale);
    ...
    {
        var identityService = new IdentityVectorService();
        var vVoicing = IdentityVectorService.ComputeEmbedding(IdentityVectorService.ObjectKind.Voicing);
    ...
    public void Invariant32_StructureVectorIsIdenticalForSamePcSet_IgnoringPerceptualArgs()
    {
        ...
        var vLowRegister = TheoryVectorService.ComputeEmbedding(pcs, rootPitchClass: 0,
            intervalClassVector: icv, consonance: 0.9, brightness: 0.2);
        var vHighRegister = TheoryVectorService.ComputeEmbedding(pcs, rootPitchClass: 0,
    ...
    public void IcvDerivedConsonance_RangesZeroToOne_AndFavoursThirdsAndFifths()
    {
        ...
        var cMajor = TheoryVectorService.ComputeEmbedding(new[] { 0, 4, 7 },
            intervalClassVector: "001110");
        // Tritone pair {0,6}: single ic6, fully dissonant.
        var tritone = TheoryVectorService.ComputeEmbedding(new[] { 0, 6 },
    ...
    public void IcvDerivedBrightness_RangesZeroToOne_AndMapsBrightToOneDarkToZero()
    {
        ...
        var bright = TheoryVectorService.ComputeEmbedding(new[] { 0, 4, 7 },
            intervalClassVector: "001110");
        // Pure tritone {0, 6}: only ic6, no bright content → brightness = 0.0.
        var dark = TheoryVectorService.ComputeEmbedding(new[] { 0, 6 },
            intervalClassVector: "000001");
        // Empty ICV → neutral 0.5.
        var neutral = TheoryVectorService.ComputeEmbedding(new[] { 0 },
