...
/// <summary>
/// ga_generate_voicing_embedding and ga_get_embedding_schema must describe the schema the
/// generator actually uses (EmbeddingSchema), not a hand-copied older layout.
/// </summary>
[TestFixture]
