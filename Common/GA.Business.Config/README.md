...
This project contains the configuration-based musical knowledge base for Guitar Alchemist, including scales, modes,
chords, and techniques, following the modular architecture Layer 2 (Domain/Data).
