namespace GA.Business.Core.Fretboard.Voicings;
...
public static class PsychoacousticVoicingAnalyzer
{
        ...
        TexturalAnalysis textural)
    {
        ...
        tags.Add(physical.Playability.ToString().ToLower());
        tags.Add(perceptual.Weight.ToString().ToLower());
        tags.Add(textural.Density.ToString().ToLower());
