    ...
    IFormattable
{
    ...
    {
        return ValueObjectUtils<IntervalQuality>.EnsureValueRange(value, _minValue, _maxValue);
    }

    public static int CheckRange(int value, int minValue, int maxValue)
    {
        return ValueObjectUtils<IntervalQuality>.EnsureValueRange(value, minValue, maxValue);
    }

    public static IntervalQuality operator !(IntervalQuality intervalQuality)
    {
        return intervalQuality.ToInverse();
    }
    ...
    /// </returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public IntervalQuality ToInverse()
    {
        ...
        out IntervalQuality quality)
    {
        ...
        static IntervalQuality? GetPerfectIntervalAccidental(Accidental? accidental)
        {
            return accidental?.Value switch
            {
                -2 => DoublyDiminished,
                -1 => Diminished,
                1 => Augmented,
        ...
        static IntervalQuality? GetImperfectIntervalAccidental(Accidental? accidental)
        {
            return accidental?.Value switch
            {
                -3 => DoublyDiminished,
    ...
    public static bool TryParse(string? s, IFormatProvider? provider, out IntervalQuality result)
    {
        ...
        if (intervalQuality is not { } quality)
        {
