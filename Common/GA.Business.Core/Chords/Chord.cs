...
public class Chord : IEquatable<Chord>
{
    ...
    public Chord(Note root, ChordFormula formula, string? symbol = null)
    {
        ...
        {
            notes.Add(root + interval.Interval);
        }
    ...
    {
        var hasMinorThird = Formula.Intervals.Any(i => i.Interval.Semitones == 3);
        var hasMajorThird = Formula.Intervals.Any(i => i.Interval.Semitones == 4);
        var hasDiminishedFifth = Formula.Intervals.Any(i => i.Interval.Semitones == 6);
        var hasAugmentedFifth = Formula.Intervals.Any(i => i.Interval.Semitones == 8);
    ...
    {
        var hasSeventh = Formula.Intervals.Any(i => i.Interval.Semitones is 10 or 11);
        var hasNinth = Formula.Intervals.Any(i => i.Interval.Semitones is 2 or 14);
        var hasEleventh = Formula.Intervals.Any(i => i.Interval.Semitones is 5 or 17);
        var hasThirteenth = Formula.Intervals.Any(i => i.Interval.Semitones is 9 or 21);
