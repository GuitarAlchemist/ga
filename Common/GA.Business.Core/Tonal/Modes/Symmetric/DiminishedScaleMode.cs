...
/// </remarks>
[PublicAPI]
public sealed class DiminishedScaleMode(DiminishedScaleDegree degree) : SymmetricScaleMode<DiminishedScaleDegree>(Scale.Diminished, degree),
    IStaticEnumerable<DiminishedScaleMode>
{
    ...
    public static IEnumerable<DiminishedScaleMode> Items => DiminishedScaleDegree.Items.Select(degree => new DiminishedScaleMode(degree));
    public static DiminishedScaleMode Get(DiminishedScaleDegree degree) => _lazyModeByDegree.Value[degree];
    public static DiminishedScaleMode Get(int degree) => _lazyModeByDegree.Value[degree];
    private static readonly Lazy<ScaleModeCollection<DiminishedScaleDegree, DiminishedScaleMode>> _lazyModeByDegree = new(() => new(Items.ToImmutableList()));
