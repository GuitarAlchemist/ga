...
/// </remarks>
[PublicAPI]
public sealed class NeapolitanMajorScaleMode(NeapolitanMajorScaleDegree degree)
    : TonalScaleMode<NeapolitanMajorScaleDegree>(Scale.NeapolitanMajor, degree),
        IStaticEnumerable<NeapolitanMajorScaleMode>
{
    ...
    public static NeapolitanMajorScaleMode LydianAugmentedDominant =>
        new(NeapolitanMajorScaleDegree.LydianAugmentedDominant);
    ...
    public static NeapolitanMajorScaleMode SuperLocrianDoubleFlat7 =>
        new(NeapolitanMajorScaleDegree.SuperLocrianDoubleFlat7);
    ...
    public static NeapolitanMajorScaleMode Get(int degree)
    {
        return _lazyModeByDegree.Value[degree];
    }
}
