...
public static class Assets
{
    ...
    public static IReadOnlyCollection<NaturalMinorScaleDegree> NaturalMinorScaleDegrees => NaturalMinorScaleDegree.Items;
    public static IReadOnlyCollection<HarmonicMinorScaleDegree> HarmonicMinorScaleDegrees => HarmonicMinorScaleDegree.Items;
    public static IReadOnlyCollection<MelodicMinorScaleDegree> MelodicMinorScaleDegrees => MelodicMinorScaleDegree.Items;
    ...
    public static Asset Get(string name) =>
        _indexedProperties.Value.TryGetValue(name, out var asset)
            ? asset
    ...
    private static ImmutableDictionary<string, Asset> LoadAssets()
    {
        ...
        var properties =
            typeof(Assets)
                ...
                .Where(prop => prop.PropertyType.IsGenericType && prop.PropertyType.GetGenericTypeDefinition() == typeof(IReadOnlyCollection<>))
        ...
        foreach (var (property, itemType) in properties)
        {
            ...
            if (asset is Asset typedAsset) builder.Add(name, typedAsset);
        }
