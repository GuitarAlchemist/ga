    ...
    IPitchClass
{
    ...
    {
        return NaturalNoteIntervals.Get(new(startNote, endNote));
    }

    public static int CheckRange(int value)
    {
        return ValueObjectUtils<NaturalNote>.EnsureValueRange(value, _minValue, _maxValue);
    }

    public static int CheckRange(int value, int minValue, int maxValue)
    {
        return ValueObjectUtils<NaturalNote>.EnsureValueRange(value, minValue, maxValue);
    }
    ...
    private static IReadOnlyCollection<NaturalNote> GetItems()
    {
        return ValueObjectUtils<NaturalNote>.Items;
    }
    ...
    private class NaturalNoteIntervals() : LazyIndexerBase<NaturalNotePair, SimpleIntervalSize>(GetKeyValuePairs())
    {
        ...
        public static SimpleIntervalSize Get(NaturalNotePair key)
        {
        ...
        {
            return from startNote in Items
    ...
    public int CompareTo(NaturalNote other)
    {
        return Value.CompareTo(other.Value);
    }

    public static bool operator <(NaturalNote left, NaturalNote right)
    {
