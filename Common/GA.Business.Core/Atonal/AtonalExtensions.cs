...
public static class AtonalExtensions
{
    ...
    {
        return items.Select(pc => new Note.Chromatic(pc)).ToImmutableList().AsPrintable();
    }
    ...
    /// </summary>
    /// <typeparam name="T">
    ///     The items type (Must implement <see cref="IValueObject" /> and
    ///     <see cref="IStaticPairIntervalClassNorm{T}" />).
    /// </typeparam>
