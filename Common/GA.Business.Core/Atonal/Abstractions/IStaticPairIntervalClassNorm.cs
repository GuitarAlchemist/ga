...
/// <summary>
/// Abstraction for a <typeparamref name="TSelf"/> to <typeparamref name="TSelf"/> <see cref="IntervalClass"/> norm, defined at the class level
/// </summary>
/// <typeparam name="TSelf">The class type</typeparam>
/// Derives from <see cref="IStaticPairNorm{TSelf,TNorm}"/>
    ...
    where TSelf : IValueObject
{
    ...
    public new static IntervalClass GetPairNorm(TSelf obj1, TSelf obj2) => IntervalClass.FromValue(Math.Abs(obj2.Value - obj1.Value));
}