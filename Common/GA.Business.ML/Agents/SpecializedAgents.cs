...
/// </summary>
public class TechniqueAgent : GuitarAlchemistAgentBase
{
    ...
    public TechniqueAgent(IChatClient chatClient, ILogger<TechniqueAgent> logger)
    ...
    private string BuildTechniquePrompt(AgentRequest _)
    {
...
/// </summary>
public class ComposerAgent : GuitarAlchemistAgentBase
{
    ...
    public ComposerAgent(IChatClient chatClient, ILogger<ComposerAgent> logger)
        : base(chatClient, logger)
    {
    }
    ...
    private string BuildComposerPrompt(AgentRequest _)
    {
        return BuildSystemPrompt() + $$$"""
...
/// </summary>
public class CriticAgent : GuitarAlchemistAgentBase
{
    ...
    public CriticAgent(IChatClient chatClient, ILogger<CriticAgent> logger)
        : base(chatClient, logger)
    {
    }
    ...
    private string BuildCriticPrompt(AgentRequest _)
    {
        return BuildSystemPrompt() + $$$"""
