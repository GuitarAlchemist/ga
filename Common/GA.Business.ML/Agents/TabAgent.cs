...
/// </para>
/// </remarks>
public class TabAgent : GuitarAlchemistAgentBase
{
    ...
    public TabAgent(IChatClient chatClient, ILogger<TabAgent> logger)
    ...
    private static bool ContainsTabNotation(string query)
    {
        ...
        var stringIndicator = lines.Any(l => tabPatterns.Any(p => l.Contains(p, System.StringComparison.OrdinalIgnoreCase)));
