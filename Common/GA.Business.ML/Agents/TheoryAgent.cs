...
///     </para>
/// </remarks>
public class TheoryAgent(IChatClient chatClient, ILogger<TheoryAgent> logger)
    : GuitarAlchemistAgentBase(chatClient, logger)
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var responseText = await ChatWithCritiqueAsync(request.Query, prompt, cancellationToken, request.ConversationHistory);
