...
This roadmap outlines the transition from brittle keyword-based testing to robust, AI-driven semantic assertions in the
Guitar Alchemist project.

## Vision

To treat the AI-generated outputs (stories, chatbot responses, theory explanations) as **cognitive surfaces** that must
land within specified **semantic basins**, rather than exact string matches.
...
- [x] **Complexity Monotonicity**: Verified that adding extensions (7, 9, 11) linearly increases sophistication
  similarity.
