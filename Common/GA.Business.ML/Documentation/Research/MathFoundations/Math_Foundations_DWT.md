...
> This document provides the mathematical foundation for multi-resolution temporal analysis used in OPTIC-K progression
> embeddings.
...
> *"This Dm7 acts as a **fast flicker** in the local ii-V pattern, while contributing to a **slow trend** toward the
relative major tonal center."*

### 5.3 Streaming Analysis

Locality allows computation on a streaming basis — chatbot provides live analysis without waiting for the entire
progression.
