...
**Extension Handling**: Extensions (78–95) are **informational only** for similarity. They are computed for
interpretability and filtering but do not contribute additional weight. If you need extensions in similarity, add them
as a 5th weighted partition with explicit weight.
...
<!-- 
Implemented by (Legacy Support):
- GA.Business.Core.Fretboard.Voicings.Search.GpuVoicingSearchStrategy
- GA.Business.Core.Fretboard.Voicings.Search.CpuVoicingSearchStrategy
-->
