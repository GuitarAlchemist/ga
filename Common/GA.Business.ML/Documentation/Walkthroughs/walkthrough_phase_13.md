...
Phase 13 introduced the **Modal Flavor Service**, enabling Guitar Alchemist to identify and tag voicings with their "
modal personality" (e.g., Lydian, Dorian) based on characteristic notes.
...
3. **Explanation**:
    * Updated `VoicingExplanationService` to support **Document-Level Explanation**, allowing it to explain tags that
      are not part of the trained vector embedding (like the new "Flavor" tags).
