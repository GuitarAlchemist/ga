...
/// </summary>
public class SymbolicQueryParser(SymbolicTagRegistry? registry = null)
{
    private readonly SymbolicTagRegistry _registry = registry ?? SymbolicTagRegistry.Instance;
