namespace GA.Domain.Services.Fretboard.Shapes;

using System.Security.Cryptography;
using System.Text;
using Core.Design.Attributes;
using Core.Design.Schema;
...
/// </summary>
[PublicAPI]
[DomainInvariant("Shape must have at least one position", "Positions.Count > 0")]
[DomainRelationship(typeof(PitchClassSet), RelationshipType.IsChildOf, "A fretboard shape realizes a pitch class set")]
[DomainRelationship(typeof(Chord), RelationshipType.IsRealizationOf,
    "A fretboard shape is a specific realization of a tonal chord")]
