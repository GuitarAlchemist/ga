...
This project contains the core music theory domain models and logic for Guitar Alchemist, following the modular architecture Layer 2 (Domain/Core).
...
- **Fretboard Analysis**: Geometric and logical representation of the fretboard, including voicing analysis and fingering.
