...
public static class HarmonicFunctionAnalyzer
{
    ...
    /// </summary>
    public static HarmonicFunction FromScaleDegree(int degree) => degree switch
    {
    ...
    public static HarmonicFunction Parse(string value)
    {
        ...
        {
            return HarmonicFunction.LeadingTone;
        }
    ...
    /// </summary>
    public static HarmonicFunctionCategory ToPrimaryCategory(HarmonicFunction function) => function switch
    {
