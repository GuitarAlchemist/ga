...
using Core.Theory.Tonal.Modes.Symmetric;
using Core.Theory.Tonal.Primitives.Diatonic;
using Core.Theory.Tonal.Primitives.Pentatonic;
using Core.Theory.Tonal.Primitives.Symmetric;
