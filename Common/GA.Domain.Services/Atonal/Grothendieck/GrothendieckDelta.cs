...
public sealed record GrothendieckDelta
{
    ...
    ///     Subtract two deltas
    /// </summary>
    public static GrothendieckDelta operator -(GrothendieckDelta a, GrothendieckDelta b) => a + -b;
    ...
    /// <inheritdoc />
    public override string ToString() => $"<{Ic1:+0;-0;0}, {Ic2:+0;-0;0}, {Ic3:+0;-0;0}, {Ic4:+0;-0;0}, {Ic5:+0;-0;0}, {Ic6:+0;-0;0}>";
}
