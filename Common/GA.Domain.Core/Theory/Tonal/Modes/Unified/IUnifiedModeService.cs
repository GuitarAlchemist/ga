...
public interface IUnifiedModeService
{
    ...
    /// </summary>
    UnifiedModeInstance FromScaleMode(ScaleMode mode, PitchClass root);
    ...
    IEnumerable<(UnifiedModeInstance Instance, int Brightness)> RankByBrightness(UnifiedModeClass modeClass,
        PitchClass root);
