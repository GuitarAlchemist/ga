...
public readonly record struct MajorScaleDegree : IRangeValueObject<MajorScaleDegree>, IScaleDegreeNaming
{
    ...
    // Constructor
    public MajorScaleDegree(int value) => _value = CheckRange(value);
    ...
    public static int CheckRange(int value) =>
        IRangeValueObject<MajorScaleDegree>.EnsureValueInRange(value, _minValue, _maxValue);

    public static int CheckRange(int value, int minValue, int maxValue) =>
        IRangeValueObject<MajorScaleDegree>.EnsureValueInRange(value, minValue, maxValue);
