...
public class DomainValidator
{
    ...
    public CompositeInvariantValidationResult Validate(object instance)
    {
        ...
        foreach (var inv in typeInvariants)
        {
            ...
            result.Add(new InvariantValidationResult(true, $"[Type] {inv.Description}", InvariantSeverity.Info));
        }
        ...
        foreach (var prop in properties)
        {
            ...
            foreach (var inv in propInvariants)
            {
                ...
                result.Add(new InvariantValidationResult(isValid, $"[Property {prop.Name}] {inv.Description}", isValid ? InvariantSeverity.Info : InvariantSeverity.Error));
            }
        }
