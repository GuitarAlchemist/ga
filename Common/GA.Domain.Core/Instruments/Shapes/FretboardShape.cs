namespace GA.Domain.Core.Instruments.Shapes;
...
[DomainRelationship(typeof(Chord), RelationshipType.IsRealizationOf, "A fretboard shape is a specific realization of a tonal chord")]
