...
/// <summary>
///     A collection of <see cref="Note.Accidented" /> notes
/// </summary>
[PublicAPI]
[CollectionBuilder(typeof(AccidentedNoteCollection), nameof(Create))]
public sealed class AccidentedNoteCollection(IReadOnlyList<Note.Accidented> notes)
    : LazyPrintableCollectionBase<Note.Accidented>(notes),
        IReadOnlyList<Note.Accidented>,
        IParsable<AccidentedNoteCollection>
{
    ...
    public Note.Accidented this[int index] => notes[index];

    public static AccidentedNoteCollection Create(ReadOnlySpan<Note.Accidented> notes) => new(notes.ToArray());
