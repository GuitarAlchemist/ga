    ...
    IPitchClass
{
    ...
    public static Pitch FromMidiNote(MidiNote midiNote) => midiNote.ToPitch();
    ...
    public sealed record Sharp(Note.Sharp Note, Octave Octave) : Pitch(Octave), IParsable<Sharp>
    {
        ...
        /// <inheritdoc />
        public static bool TryParse(string? s, IFormatProvider? provider, out Sharp result) => PitchParser.TryParse<SharpAccidental, Note.Sharp, Sharp>(
                s,
    ...
    public sealed record Flat(Note.Flat Note, Octave Octave) : Pitch(Octave), IParsable<Flat>
    {
        ...
        /// <inheritdoc />
        public static bool TryParse(string? s, IFormatProvider? provider, out Flat result) => PitchParser.TryParse<FlatAccidental, Note.Flat, Flat>(
                s,
                (naturalNote, accidental) => new(naturalNote, accidental),
                (note, octave) => new(note, octave),
                out result);
