...
public abstract partial record Interval : IComparable<Interval>, IComparable
{
    ...
    public sealed partial record Simple : Diatonic, IParsable<Simple>, IFormattable
    {
        ...
        public Compound ToCompound() =>
            new() { Size = Size.ToCompound(), Quality = Quality };
...
#pragma warning disable IDE1006 // Naming Styles
        ...
        /// </summary>
        public static Simple dd1 =>
            new() { Quality = IntervalQuality.DoublyDiminished, Size = SimpleIntervalSize.Unison };
        ...
        /// </summary>
        public static Simple AA1 =>
            new() { Quality = IntervalQuality.DoublyAugmented, Size = SimpleIntervalSize.Unison };

        /// <summary>
        ///     A double diminished second <see cref="Interval.Simple" />
        /// </summary>
        public static Simple dd2 =>
            new() { Quality = IntervalQuality.DoublyDiminished, Size = SimpleIntervalSize.Second };
        ...
        /// </summary>
        public static Simple AA2 =>
            new() { Quality = IntervalQuality.DoublyAugmented, Size = SimpleIntervalSize.Second };
...
#pragma warning disable IDE1006 // Naming Styles
        ...
        /// </summary>
        public static Compound P15 =>
            new() { Quality = IntervalQuality.Perfect, Size = CompoundIntervalSize.DoubleOctave };
