...
/// <remarks>
///     Example:
///     - 9 = Octave + Second (9 semitones)
/// </remarks>
[PublicAPI]
public readonly record struct CompoundIntervalSize : IParsable<CompoundIntervalSize>,
    IIntervalSize<CompoundIntervalSize>
{
    private const int _minValue = CompoundIntervalSizeValues.NinthValue;
    private const int _maxValue = CompoundIntervalSizeValues.SixteenthValue;
    ...
    public static int CheckRange(int value) =>
        ValueObjectUtils<CompoundIntervalSize>.EnsureValueRange(value, _minValue, _maxValue);

    /// <summary>
    ///     Ensure the value is in range.
    /// </summary>
    public static int CheckRange(int value, int minValue, int maxValue) =>
        ValueObjectUtils<CompoundIntervalSize>.EnsureValueRange(value, minValue, maxValue);
    ...
    /// </summary>
    public static IReadOnlyList<int> Values => ValueObjectUtils<CompoundIntervalSize>.ValuesList;
    ...
    /// </summary>
    /// <returns>The <see cref="Intervals.Semitones" /></returns>
