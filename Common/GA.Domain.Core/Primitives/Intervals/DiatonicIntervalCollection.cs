...
[CollectionBuilder(typeof(DiatonicIntervalCollection), nameof(Create))]
        ...
        IReadOnlyCollection<DiatonicInterval>
{
    ...
    public static DiatonicIntervalCollection Create(ReadOnlySpan<DiatonicInterval> intervals) =>
        new(intervals.ToArray());
    ...
    public IEnumerator<DiatonicInterval> GetEnumerator() => Intervals.GetEnumerator();
