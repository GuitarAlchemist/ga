...
public sealed record FretboardRange
{
    ...
    /// </summary>
    public ImmutableHashSet<int> AvailableStrings { get; init; } = ImmutableHashSet<int>.Empty;
    ...
    {
        var strings = Enumerable.Range(1, stringCount).ToImmutableHashSet();
        return new FretboardRange
        {
            MinFret = minFret,
            MaxFret = maxFret,
