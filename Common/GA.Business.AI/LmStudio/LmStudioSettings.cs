...
public class LmStudioSettings
{
    ...
    public string SystemPrompt { get; set; } =
        "You are a guitar expert assistant. Your knowledge includes detailed information about guitar fretboard positions, chords, scales, and music theory. Always provide accurate and helpful information about guitar playing techniques, music theory, and fretboard navigation.";
