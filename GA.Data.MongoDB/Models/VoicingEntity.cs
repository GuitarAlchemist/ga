...
public class VoicingEntity
{
    ...
    /// <summary>
    /// Keys where this voicing fits diatonically (e.g. ["C Major", "F Major"])
    /// </summary>
    [BsonElement("possibleKeys")]
    ...
    /// <summary>
    /// Roughness proxy 0.0-1.0 (psychoacoustic beating estimate)
    /// </summary>
    [BsonElement("roughness")]
    public double Roughness { get; set; }

    /// <summary>
    /// Spacing classification: Close, Mixed, or Open
    /// </summary>
    [BsonElement("spacing")]
    public string? Spacing { get; set; }

    /// <summary>
    /// Confidence in root detection (0.0 = guess, 1.0 = certain)
    /// </summary>
    [BsonElement("rootConfidence")]
    public double RootConfidence { get; set; }

    /// <summary>
    /// Detected root pitch class value (0-11, where 0=C, 1=C#, etc.)
    /// </summary>
    [BsonElement("rootPitchClass")]
    public int? RootPitchClass { get; set; }

    /// <summary>
    /// Stacking type (e.g., "Tertial", "Quartal", "Secundal")
    /// </summary>
    [BsonElement("stackingType")]
    public string? StackingType { get; set; }
    
    /// <summary>
    /// Bass note inversion (0=Root, 1=1st inv, etc.)
    /// </summary>
    [BsonElement("inversion")]
    public int Inversion { get; set; }

    /// <summary>
    /// MIDI note for the bass (lowest sounding pitch)
    /// </summary>
    [BsonElement("midiBassNote")]
    public int MidiBassNote { get; set; }
    ...
    /// <summary>
    /// Numeric difficulty score (1.0-10.0)
    /// </summary>
    ...
    public double[]? TextEmbedding { get; set; }

    /// <summary>
    /// The model used to generate the text embedding
    /// </summary>
    [BsonElement("textEmbeddingModel")]
    ...
    /// <summary>
    /// Name of the analysis engine that produced this data (for traceability)
    /// </summary>
    [BsonElement("analysisEngine")]
    public string? AnalysisEngine { get; set; }

    /// <summary>
    /// Version/date stamp of the analysis engine
    /// </summary>
    [BsonElement("analysisVersion")]
    public string? AnalysisVersion { get; set; }

    /// <summary>
    /// List of jobs/processes that updated this entity
    /// </summary>
    [BsonElement("jobs")]
