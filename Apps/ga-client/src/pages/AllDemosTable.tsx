...
const demoPages: DemoPageInfo[] = [
  ...
  },
  {
    ...
    url: '/test/harmonic-navigator-3d',
  ...
  },
  {
    ...
    url: '/test/immersive-musical-world',
  ...
  },
  {
    ...
    technology: 'React + Material-UI + F# Parser + REST API',
    url: '/test/chord-progression-dsl',
  ...
  },
  {
    ...
    technology: 'React + Material-UI + F# Parser + REST API',
    url: '/test/fretboard-navigation-dsl',
    ...
    <Container maxWidth="xl" sx={{ py: 4 }}>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body2" color="info.main" paragraph>
          💡 Demos open in a new tab with their own breadcrumb navigation.
