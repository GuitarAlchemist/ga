...
{
    public string ProgressionId { get; set; } = string.Empty;
    public List<string> OriginalChords { get; set; } = [];
...
public class HandPoseResponse
{
    ...
    public Dictionary<string, object> HandPosition { get; set; } = [];
    public List<FingerPosition> FingerPositions { get; set; } = [];
...
public class GuitarMappingRequest
{
    ...
    public List<string> PreferredShapes { get; set; } = [];
    public Dictionary<string, object> Constraints { get; set; } = [];
...
public class GuitarMappingResponse
{
    public string Id { get; set; } = string.Empty;
    public string ChordName { get; set; } = string.Empty;
    public List<FretboardPosition> Positions { get; set; } = [];
    public Dictionary<string, object> MappingData { get; set; } = [];
    public DateTime GeneratedAt { get; set; } = DateTime.UtcNow;
}
