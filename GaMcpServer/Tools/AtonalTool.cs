...
{
    [McpServerTool]
    [Description("Get all set classes")]
    public static IEnumerable<string> GetSetClasses()
    {
        return SetClass.Items.Select(sc => sc.ToString());
    }

    [McpServerTool]
    [Description("Get all modal set classes")]
    public static IEnumerable<string> GetModalSetClasses()
    {
        return SetClass.ModalItems.Select(sc => sc.ToString());
    }

    [McpServerTool]
    [Description("Get modal family information")]
    ...
    [McpServerTool]
    [Description("Get all cardinalities")]
    public static IEnumerable<string> GetCardinalities()
    {
        return Cardinality.Items.Select(c => c.ToString());
    }
}
