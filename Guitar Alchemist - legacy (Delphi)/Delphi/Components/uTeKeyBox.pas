...
type
   ...
   TTeKeyBox = class(TTeComboBox)
      ...
      protected
         ...
         procedure DrawItem(Control: TWinControl; Canvas: TCanvas; Index: Integer; Rect: TRect; State: TOwnerDrawState); reintroduce;
      public
...
procedure TTeKeyBox.Loaded;
begin
   inherited Loaded;
   itemHeight := -ClientHeight;
end;

procedure TTeKeyBox.Resize;
begin
   itemHeight := height;
   font.size := height;
end;
   ...
   if HandleAllocated
      then begin
              ...
              try
                    ...
                    case fMode of
                       kmBoth:
                          for index := 1 to Ord(High(MAJOR_KEY_NAME)) do
...
begin
   ...
   canvas.font.style := [];
   DrawKeySignatureRect(canvas, lRect, TKey(index + 1));
