 ...
 * @param {any} dotNetObjectRef // The reference to the DotNet object
 * @param {any} gridElement // The html grid element
 ...
 */
export function gridInit(dotNetObjectRef, gridElement, existingGridOptions, gridColumns) {
    if (!gridElement) {
    ...
    console.log(`Initialized maintenance grid`);
