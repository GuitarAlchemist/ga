...
$Services = @(
    @{
        ...
        WorkingDir  = Join-Path $RepoRoot 'ReactComponents\ga-react-components'
        Exe         = 'pnpm.cmd'
    ...
    @{
        ...
        WorkingDir  = Join-Path $RepoRoot 'Apps\ga-server\GaApi'
        Exe         = 'dotnet.exe'
    ...
    @{
        ...
        WorkingDir  = Join-Path $RepoRoot 'Apps\GaChatbot.Api'
        Exe         = 'dotnet.exe'
